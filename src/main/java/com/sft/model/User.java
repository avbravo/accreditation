...
public class User {
   ...
   @Column
    ...
    public User(Long iduser, String username, String cellphone, String email, String identificationcard, String sex, String socialsecuritynumber, String name, String password, String photo, Boolean active, List<Profile> profile) {
        this.iduser = iduser;
