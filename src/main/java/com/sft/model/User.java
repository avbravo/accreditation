...
public class User {
    ...
    public User(Long iduser, String username, String cellphone, String email, String identificationcard, String sex, String socialsecuritynumber, String name, String password, String photo, Date dateofbirth, CentralView centralView, List<Profile> profile, Boolean active) {
        this.iduser = iduser;
        this.username = username;
        this.cellphone = cellphone;
        this.email = email;
    ...
    public int hashCode() {
        ...
        hash = 19 * hash + Objects.hashCode(this.centralView);
