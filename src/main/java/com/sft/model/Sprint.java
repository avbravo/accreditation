...
List<ActionHistory> actionHistory;
    ...
    public Sprint(Long idsprint, String sprint, String descripcion, Date fechainicial, Date fechafinal, Boolean open, ProyectoView proyectoView, EstadisticaCierre estadisticaCierre, List<ActionHistory> actionHistory, Boolean active) {
    ...
    public int hashCode() {
        int hash = 3;
        hash = 29 * hash + Objects.hashCode(this.idsprint);
        hash = 29 * hash + Objects.hashCode(this.sprint);
        ...
        hash = 29 * hash + Objects.hashCode(this.proyectoView);
        hash = 29 * hash + Objects.hashCode(this.estadisticaCierre);
